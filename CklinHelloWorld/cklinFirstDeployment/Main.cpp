...
#include <CklinHelloWorld/cklinFirstDeployment/Top/cklinFirstDeploymentTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
static void signalHandler(int signum) {
    CklinHelloWorld::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    CklinHelloWorld::TopologyState inputs;
    ...
    CklinHelloWorld::setupTopology(inputs);
    CklinHelloWorld::startRateGroups(Fw::TimeInterval(1, 0));  // Program loop cycling rate groups at 1Hz
    CklinHelloWorld::teardownTopology(inputs);
