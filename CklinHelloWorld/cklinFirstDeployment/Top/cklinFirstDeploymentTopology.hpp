// ======================================================================
// \title  cklinFirstDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CKLINFIRSTDEPLOYMENT_CKLINFIRSTDEPLOYMENTTOPOLOGY_HPP
#define CKLINFIRSTDEPLOYMENT_CKLINFIRSTDEPLOYMENTTOPOLOGY_HPP
// Included for access to cklinFirstDeployment::TopologyState and cklinFirstDeployment::ConfigObjects::pingEntries.
// These definitions are required by the autocoder, but are also used in this hand-coded topology.
#include <CklinHelloWorld/cklinFirstDeployment/Top/cklinFirstDeploymentTopologyDefs.hpp>
 ...
 * cklinFirstDeployment::TopologyState see: cklinFirstDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type CklinHelloWorld::TopologyState see: CklinHelloWorldTopologyDefs.hpp.
 *
